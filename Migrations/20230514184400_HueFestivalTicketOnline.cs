...
{
    /// <inheritdoc />
    public partial class HueFestivalTicketOnline : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Longtitude = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Laititude = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Event_ProgramType_Type_program",
                        column: x => x.Type_program,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavouriteEvent", x => new { x.UserId, x.EventId });
                    table.ForeignKey(
                        name: "FK_FavouriteEvent_Event_EventId",
                        column: x => x.EventId,
                        principalTable: "Event",
                        principalColumn: "EventId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FavouriteEvent_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Notification", x => new { x.UserId, x.EventId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Event_Type_program",
                table: "Event",
                column: "Type_program");

            migrationBuilder.CreateIndex(
                name: "IX_FavouriteEvent_EventId",
